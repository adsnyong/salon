...
INSERT INTO public.customers VALUES (1, '101110111', 'adsn');
...
--
-- Name: appointments cus_id; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT cus_id FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id);


--
-- Name: appointments serve_id; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT serve_id FOREIGN KEY (service_id) REFERENCES public.services(service_id);
